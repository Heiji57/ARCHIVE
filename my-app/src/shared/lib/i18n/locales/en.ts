...
export const en: Dict = {
  ...
  "topic.doc.stalledTitle": "This digest is stuck",
  "topic.doc.stalledDesc": "The server started the digest but has made no progress since. The job appears to have stopped. If retrying leaves it in the same state, the server needs a look. Your previously generated document is untouched.",
  "topic.doc.stalledRetry": "Try again",
  "topic.doc.stalledViewPrevious": "View previous document",
