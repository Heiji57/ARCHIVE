...
export const ja: Dict = {
  ...
  "todo.dueDate.label": "期限日",
  "todo.dueDate.none": "なし",
  "todo.dueDate.clear": "期限日を削除",
  "todo.tag.title": "タグ",
  ...
  "retro.search.scopeGlobal": "すべてから検索中",
  "retro.search.scopeFiltered": "すべてのフォルダに絞り込み中",
  "retro.search.backToFolder": "{path} に戻る",
  "retro.card.unfiled": "未分類",
  ...
  "topic.doc.stalledTitle": "整理が止まっています",
  "topic.doc.stalledDesc": "サーバーが整理を開始したあと、進捗がありません。処理が中断されたようです。再試行しても同じ状態なら、サーバー側の確認が必要です。以前に整理した文書はそのまま残っています。",
  "topic.doc.stalledRetry": "再試行",
  "topic.doc.stalledViewPrevious": "以前の文書を見る",
