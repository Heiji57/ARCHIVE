...
export const zh: Dict = {
  ...
  "subheader.dashboard.eyebrow": "工作区",
  "subheader.dashboard.title": "仪表盘",
  "subheader.dashboard.subtitle": "一眼掌握今天的节奏与本周进度。",
  ...
  "dashboard.writeRetro": "写回顾",
  "dashboard.stat.doneToday": "今日完成",
  "dashboard.stat.doneWeek": "本周完成",
  "dashboard.stat.doneMonth": "本月完成",
  "dashboard.stat.completionRate": "完成率",
  "dashboard.stat.retroCount": "已写回顾",
  "dashboard.unit.count": "个",
  "dashboard.count": "{n}个",
  "dashboard.rings.completion": "完成率",
  "dashboard.rings.inProgress": "进行中",
  "dashboard.rings.notDone": "未完成",
  "dashboard.weekly.title": "每周完成趋势",
  "dashboard.tags.title": "标签分布",
  "dashboard.tags.empty": "还没有标签",
  "dashboard.timeline.title": "今日时间线",
  "dashboard.timeline.done": "{done} / {total} 完成",
  "dashboard.timeline.empty": "今天没有安排",
  ...
  "todo.recurrence.timeTitle": "更改重复任务时间",
  "todo.recurrence.fieldTitle": "将此更改应用于",
  ...
  "todo.dueDate.label": "截止日期",
  "todo.dueDate.none": "无",
  "todo.dueDate.clear": "移除截止日期",
  "todo.tag.title": "标签",
  "todo.tag.placeholder": "添加标签...",
  "todo.tag.add": "添加标签",
  "todo.tag.remove": "移除标签 {tag}",
  "todo.tag.limit": "最多 {max} 个",
  "todo.tag.recent": "最近使用",
  "todo.tag.searchResults": "搜索结果",
  "todo.tag.createNew": "新建“{tag}”",
  "todo.tag.noResults": "没有匹配的标签",
  "todo.tag.chipOff": "标签",
  "todo.tag.done": "完成",
  ...
  "retro.search.scopeGlobal": "正在全局搜索",
  "retro.search.scopeFiltered": "已跨全部文件夹筛选",
  "retro.search.backToFolder": "返回 {path}",
  "retro.card.unfiled": "未分类",
  ...
  "topic.doc.stalledTitle": "整理已停滞",
  "topic.doc.stalledDesc": "服务器开始整理后没有任何进展，任务似乎已中断。若重试后仍是同样状态，需要检查服务器。此前整理的文档保持不变。",
  "topic.doc.stalledRetry": "重试",
  "topic.doc.stalledViewPrevious": "查看此前的文档",
  ...
  "settings.writing.spellCheck": "拼写检查下划线",
  "settings.writing.spellCheckHint": "在编辑器中显示浏览器对拼写错误单词的红色下划线。",
  ...
  "settings.group.writing.hint": "调整编辑器的写作行为。",
